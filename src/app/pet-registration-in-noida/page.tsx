  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="keywords" 
          content="Noida pet registration, Noida Authority pet registration, Noida dog registration, pet registration Noida, dog registration Noida, Noida Authority pet registration online, pet certificate Noida, pet compliance Noida, pet registration law Noida, ABC rules Noida, Supreme Court pet registration Noida, Noida Authority enforcement, Noida pet fine ₹10000, Noida pet seizure" 
        />
        <link rel="canonical" href="https://tailio.com/noida" />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tailio.com/noida" />
        <meta property="og:title" content="Noida Pet Registration | Noida Authority Pet Registration Online | Tailio" />
        <meta 
        ...
        />
        <meta property="og:image" content="https://tailio.com/images/og-noida.jpg" />
        ...
        <meta name="twitter:url" content="https://tailio.com/noida" />
        <meta name="twitter:title" content="Noida Pet Registration | Noida Authority Pet Registration Online | Tailio" />
        <meta 
          name="twitter:description" 
          content="Register your pet with Noida Authority in under 60 seconds. Get your official pet registration certificate in 24-72 hours. Starting at ₹999. Avoid ₹10,000 fine." 
        />
        <meta name="twitter:image" content="https://tailio.com/images/og-noida.jpg" />
        ...
        {/* Schema.org structured data for Noida page */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Noida Pet Registration with Noida Authority",
              "description": "Complete guide to pet registration in Noida. Register your pet with Noida Authority through Tailio in under 60 seconds. Avoid ₹10,000 fine.",
              "url": "https://tailio.com/noida",
              "mainEntity": {
                "@type": "LocalBusiness",
                "name": "Tailio - Noida Pet Registration",
                "description": "Digital pet registration service for Noida residents. File directly with Noida Authority.",
                "url": "https://tailio.com/noida",
                "address": {
                  "@type": "PostalAddress",
                ...
                "availableService": [
                  {
                    "@type": "Service",
                    "name": "Noida Authority Pet Registration",
                    "description": "File pet registration with Noida Authority",
        ...
        {/* FAQ Schema for Noida-specific FAQs */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Noida Pet Registration",
                  "item": "https://tailio.com/noida"
                }
              ]
            })
          }}
      ...
      <main className="min-h-screen bg-[#FAF6EF]">
        ...
        <section className="relative overflow-hidden pt-20 pb-12 px-4">
          ...
          <div className="absolute left-8 top-20 opacity-[0.06] text-[#E8600A] text-6xl rotate-[-19deg]">✦</div>
          <div className="absolute right-8 top-40 opacity-[0.06] text-[#E8600A] text-4xl rotate-[17deg]">✦</div>
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#FFF0E4] rounded-full px-3 py-1.5 border border-[#FFCCA0] mb-6">
              ...
              <span className="text-[#C04E06] text-sm font-medium">Noida Authority · UP · Registration Live</span>
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-[#2C1A0E] leading-tight mb-4">
              Pet registration
              <span className="text-[#E8600A] italic block sm:inline"> in Noida.</span>
            </h1>

            <p className="text-[#7A5C40] text-base sm:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
              Noida has the steepest fine in all of Delhi NCR — ₹10,000. The Noida Authority is actively penalising pet owners at society gates and RWA drives. Register before the next drive hits your sector.
            </p>
            ...
            <button 
              ...
              aria-label="Register your pet with Noida Authority now"
            >
        ...
        {/* Stats Bar */}
        <section className="bg-[#2C1A0E] py-8 px-4" aria-label="Noida pet registration statistics">
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { value: 'Active', label: 'Noida Authority enforcement status', sub: 'India · WHO data' },
        ...
        <section className="py-20 px-4 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              <div className="text-[#E8600A] text-xs font-medium uppercase tracking-widest mb-2">The Law · Noida</div>
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mb-4">
                Pet registration isn't optional<br/>in <span className="text-[#E8600A] italic">Noida.</span>
              </h2>
              <p className="text-[#7A5C40] text-base leading-relaxed mb-6">
                Noida Authority has the most aggressive enforcement in NCR. Active fines of ₹10,000 have been issued and pet seizures reported across sectors since the Supreme Court's August 2025 order.
              </p>
              <div className="bg-white rounded-xl p-4 border-l-4 border-transparent shadow-sm">
                <div className="flex gap-3">
                  <div className="flex-shrink-0 w-5 h-5 bg-[#FDECEA] rounded-full flex items-center justify-center mt-0.5">
                    <span className="text-[#A0251E] text-[9px] font-semibold">!</span>
                  </div>
                  <div>
                    <div className="text-[#2C1A0E] text-sm font-semibold">Noida — key fact</div>
                    <div className="text-[#7A5C40] text-xs leading-relaxed">Noida Authority is the most active enforcer in NCR. Fines have been issued at society gates, parks and RWA drives — with pet seizures on record.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2C1A0E] rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-[#F4E4CF]/30 text-xs font-mono uppercase tracking-wider mb-1">Non-compliance fine · Noida Authority</div>
                <div className="text-6xl md:text-7xl font-black text-[#FF8C3A]">₹10,000</div>
                <div className="text-[#F4E4CF]/40 text-sm mt-1">Highest fine in all of NCR — Noida Authority actively penalising</div>
                <div className="mt-6 space-y-3">
                  {[
                    ...
                    { icon: 'clock', text: 'Noida Authority portal fee ₹100–500 · 2–3 weeks wait' }
                  ].map((item, index) => (
        ...
        <section className="py-20 px-4 bg-[#F3EDE0]">
          <div className="max-w-5xl mx-auto">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mt-2">Four reasons every Noida pet owner needs this.</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { title: 'Legal Identity & Protection', desc: 'Unique Noida Authority ID — proof of ownership and full legal status. Legally protected at all times.', icon: 'shield' },
        ...
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#F4E4CF]/40 text-sm max-w-lg mx-auto mt-3">Upload digitally on Tailio — no photocopies, no office visits. We handle the Noida Authority filing for you.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { title: 'Address Proof', desc: 'Proof you reside in Noida. Must show your current address clearly.', details: ['Aadhaar Card (serves as both)', 'Electricity or water bill', 'Rental agreement or bank statement'], icon: 'address' },
        ...
        {/* Comparison Table */}
        <section className="py-20 px-4 bg-[#FFF0E4]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="text-[#E8600A] text-xs font-medium uppercase tracking-widest">Tailio vs Noida Authority Portal</div>
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mt-2">
                Or spend a weekend at the
                <span className="text-[#E8600A] italic block font-bold">Noida Authority office.</span>
              </h2>
            </div>
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-[#2C1A0E] grid grid-cols-3">
                ...
                <div className="px-6 py-6 text-center"><span className="text-[#F4E4CF]/35 text-[10px] font-mono uppercase tracking-wider">Noida Authority Portal</span></div>
              </div>
              {[
                ...
                { label: 'If you wait, the fine is…', sub: 'Noida Authority enforcement active', tailio: 'None', portal: '₹10,000' },
              ].map((row, i) => (
                <div key={i} className="grid grid-cols-3 border-b border-[#2C1A0E]/10 last:border-0 bg-[#FFFCF8]">
                  ...
                  <div className="px-6 py-4 flex items-center justify-center">
                    {typeof row.portal === 'string' ? (
                      <span className={`text-sm ${row.portal === '₹10,000' ? 'text-[#A0251E] font-bold' : 'text-[#2C1A0E]'}`}>{row.portal}</span>
                    ) : (
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#2C1A0E" strokeWidth="2">
        ...
        <section className="py-20 px-4 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#7A5C40] text-sm max-w-lg mx-auto mt-3">No PDFs, no notarised forms, no office visits. Works on any phone, anywhere in Noida.</p>
          </div>
          <div className="relative">
            ...
            {[
              ...
              { num: 2, title: 'Upload your 4 documents', desc: 'Upload digitally — JPG, PNG or PDF. No photocopies, no office visit. We handle the Noida Authority filing on your behalf.', tags: ['Anti-Rabies Cert', 'ID + Address Proof', 'Photo with pet'] },
              { num: 3, title: 'We file with Noida Authority. You get your certificate.', desc: 'Tailio submits directly to Noida Authority. Your official digital certificate arrives by email within 24–72 hours. No office visit. Ever.', tags: ['Registered in Noida', 'No office visit', 'Verified'] },
            ].map((step, i) => (
                      ...
                      {step.num === 3 && (
                        <div className="mt-6 bg-[#2C1A0E] rounded-xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                          <div>
                            ...
                            <div className="text-[#F4E4CF]/35 text-[10px] font-mono tracking-wider">TL-NO-2025-71294</div>
                            <div className="flex flex-wrap gap-2 mt-3">
                              {['Registered in Noida', 'No office visit', 'Verified'].map((tag) => (
        ...
        <section className="py-20 px-4 max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <div className="w-10 h-10 bg-[#E8600A] rounded-full flex items-center justify-center text-white font-bold">A</div>
            <div className="text-left">
              <div className="flex items-center gap-2">
                <span className="text-[#2C1A0E] font-semibold">Arjun Mehta</span>
                <span className="px-2 py-0.5 bg-[#FFF0E4] rounded-full text-[#C04E06] text-xs font-semibold border border-[#FFCCA0]">🐾 Luna</span>
              </div>
              <div className="text-[#7A5C40] text-xs">Sector 62, Noida</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#F4E4CF]/40 text-sm mt-3 max-w-lg mx-auto">Sixty seconds from here to legally issued. Certificate valid with Noida Authority.</p>
            <div className="mt-12 bg-white/5 rounded-2xl p-8 md:p-10 border border-[#E8600A]/30 relative overflow-hidden">
              ...
              <div className="relative z-10 mt-6">
                ...
                <div className="text-[#F4E4CF]/40 text-xs mt-1">Per pet · Valid 1 year · All taxes inclusive · Noida Authority accepted</div>
              </div>
              ...
              <button 
                ...
                aria-label="Register your pet with Noida Authority now for ₹999"
              >
                Register Your Pet — ₹999 →
              </button>
