...
export default function AboutPage() {
  return (
    <div className="flex flex-col bg-white font-['Nunito']">
      <div className="flex flex-col items-start self-stretch bg-[#FFF0E4] pb-[72px] pt-[80px]">
        ...
        <div className="flex items-start self-stretch mb-3" style={{ background: "linear-gradient(180deg, #FFFAF4, #FFF3E0, #FFF0E4)" }}>
          ...
          <div className="flex flex-col shrink-0 items-start">
            ...
            <div className="flex flex-col items-center mb-6">
              <span className="text-[#2C1A0E] text-[52px] font-black text-center w-[413px] tracking-[-1px] leading-[57px]">
                Built by pet parents,<br />for every pet parent.
              </span>
            </div>
            <span className="text-[#6B3A1F] text-[17px] font-normal w-[557px] mb-10 leading-relaxed">
            ...
            <div className="flex items-start ml-[26px]">
              <div className="flex flex-col shrink-0 items-center mt-1.5 mr-16 gap-[3px]">
                <div className="flex flex-col items-center">
                  <span className="text-[#D96F28] text-[28px] font-black">2024</span>
                </div>
              ...
              <div className="flex flex-col shrink-0 items-center mt-1.5 mr-16 gap-[3px]">
                <div className="flex flex-col items-start px-[9px]">
                  <span className="text-[#D96F28] text-[28px] font-black">50K+</span>
                </div>
              ...
              <div className="flex flex-col shrink-0 items-center mr-[52px] gap-[3px]">
                <div className="flex flex-col items-start px-5">
                  <span className="text-[#D96F28] text-[28px] font-black">4</span>
                </div>
                <div className="flex flex-col items-center pb-[1px]">
                  <span className="text-[#A07050] text-xs font-normal">Cities live</span>
                </div>
              </div>
              <span className="text-[#D96F28] text-[28px] font-black mr-3.5">1 min</span>
              <span className="text-[#A07050] text-xs font-normal mt-[41px]">To register</span>
            </div>
          </div>
          <div className="flex-1 self-stretch" />
          <img
        ...
        <div className="flex flex-col items-start self-stretch max-w-[1094px] mx-auto mb-3.5">
          <span className="text-[#2C1A0E] text-4xl font-black">Why we built Tailio</span>
        </div>
        ...
        <div className="flex items-start self-stretch max-w-[1094px] mb-5 mx-auto gap-[66px]">
          ...
          <div className="flex-1 relative mt-[72px]">
            <div className="flex flex-col bg-white pt-[33px] pr-[33px] rounded-3xl border border-solid border-[#F0D5B8] shadow-[0px_8px_40px_#B464281A]">
              <span className="text-[#FFDBB8] text-[80px] mb-3.5 ml-[33px] font-black">"</span>
              <div className="flex flex-col mb-4 ml-[33px]">
                <span className="text-[#2C1A0E] text-lg font-normal leading-relaxed">
            ...
            <button className="flex flex-col items-center bg-[#FF8C42] absolute top-[-17px] right-[-17px] py-3.5 px-[18px] gap-[3px] rounded-[14px] border-0 shadow-[0px_6px_20px_#FF8C4257]">
              <span className="text-white text-[26px] font-black">913</span>
              <span className="text-white text-[11px] font-normal text-center w-[84px]">
        ...
        <div className="flex flex-col items-center self-stretch bg-[#2C1A0E] pt-20 mb-[122px]">
          ...
          <div className="flex flex-col items-start pt-0.5 px-[107px] mb-3.5">
            <span className="text-[#FFF3E0] text-4xl font-black">Our mission & vision</span>
          </div>
          <div className="flex flex-col items-start px-6 mb-[47px]">
            <span className="text-[#FFF3E0] text-[15px] font-normal leading-relaxed">
          ...
          <div className="flex items-start mb-[34px]">
            <div className="flex flex-col shrink-0 items-center mr-[66px] gap-2.5">
              ...
              <span className="text-[#FFF3E0] text-[13px] font-normal w-[121px] leading-relaxed">
            ...
            <div className="flex flex-col shrink-0 items-center mr-[66px] gap-2.5">
              ...
              <span className="text-[#FFF3E0] text-[13px] font-normal w-[125px] leading-relaxed">
            ...
            <div className="flex flex-col shrink-0 items-center gap-2.5">
              ...
              <span className="text-[#FFF3E0] text-[13px] font-normal w-[126px] leading-relaxed">
        ...
        <div className="flex flex-col self-stretch max-w-[992px] mb-20 mx-auto gap-[52px]">
          <div className="flex flex-col items-center self-stretch gap-3.5">
            ...
            <div className="flex flex-col items-center self-stretch pt-0.5">
              <span className="text-[#2C1A0E] text-4xl font-black">Meet our Founders</span>
            </div>
            <div className="flex flex-col items-start px-1">
              <span className="text-[#6B3A1F] text-[15px] font-normal text-center w-[468px] leading-relaxed">
          ...
          <div className="flex items-start self-stretch pb-[45px] gap-4">
            ...
            <div className="flex flex-1 flex-col items-start bg-white pt-[1px] rounded-[20px] border border-solid border-[#FAF0E6]">
              ...
              <div className="flex flex-col items-start self-stretch pt-2 mb-[45px] mx-[21px]">
                <span className="text-[#6B3A1F] text-[13px] font-normal w-48 leading-relaxed">
            ...
            <div className="flex flex-1 flex-col items-start bg-white pt-[1px] rounded-[20px] border border-solid border-[#FAF0E6]">
              ...
              <div className="flex flex-col self-stretch pt-2 mb-[45px] mx-[21px]">
                <span className="text-[#6B3A1F] text-[13px] font-normal w-[193px] leading-relaxed">
        ...
        <div className="flex flex-col self-stretch max-w-[1032px] mb-[97px] mx-auto gap-[47px]">
          <div className="flex flex-col items-center self-stretch gap-3.5">
            ...
            <div className="flex flex-col items-center self-stretch pt-0.5">
              <span className="text-[#2C1A0E] text-4xl font-black">Our values</span>
            </div>
            <div className="flex flex-col items-start px-2.5">
              <span className="text-[#6B3A1F] text-[15px] font-normal text-center w-[437px] leading-relaxed">
            ...
            <div className="flex items-center self-stretch gap-4">
              <div className="flex flex-1 items-start bg-white py-[29px] px-[25px] gap-[18px] rounded-[18px] border border-solid border-[#FAF0E6]">
                ...
                <div className="flex flex-1 flex-col gap-[7px]">
                  ...
                  <div className="flex flex-col items-start self-stretch">
                    <span className="text-[#6B3A1F] text-[13px] font-normal w-[389px] leading-relaxed">
              ...
              <div className="flex flex-1 items-start bg-white py-[29px] px-[25px] gap-[18px] rounded-[18px] border border-solid border-[#FAF0E6]">
                ...
                <div className="flex flex-1 flex-col gap-[7px]">
                  ...
                  <div className="flex flex-col items-start self-stretch">
                    <span className="text-[#6B3A1F] text-[13px] font-normal w-96 leading-relaxed">
            ...
            <div className="flex items-center self-stretch gap-4">
              <div className="flex flex-1 items-start bg-white py-[29px] px-[25px] gap-[18px] rounded-[18px] border border-solid border-[#FAF0E6]">
                ...
                <div className="flex flex-1 flex-col gap-[7px]">
                  ...
                  <div className="flex flex-col items-start self-stretch">
                    <span className="text-[#6B3A1F] text-[13px] font-normal w-[382px] leading-relaxed">
              ...
              <div className="flex flex-1 items-start bg-white py-[29px] px-[25px] gap-[18px] rounded-[18px] border border-solid border-[#FAF0E6]">
                ...
                <div className="flex flex-1 flex-col gap-[7px]">
                  ...
                  <div className="flex flex-col items-start self-stretch">
                    <span className="text-[#6B3A1F] text-[13px] font-normal w-[376px] leading-relaxed">
        ...
        <div className="flex flex-col items-center self-stretch bg-[#2C1A0E] pt-20 pb-[81px] px-[196px] mb-[158px]">
          <div className="flex flex-col items-center self-stretch mb-[13px]">
            <span className="text-white text-[40px] font-black">Ready to register your pet?</span>
          </div>
          <div className="flex flex-col items-center mb-3">
            <span className="text-white text-base font-normal text-center w-[479px] leading-relaxed">
        ...
        <div className="flex items-center self-stretch max-w-[1086px] mx-auto">
          ...
          <div className="flex flex-col shrink-0 items-start mr-[130px]">
            ...
            <span className="text-[#FF8C42] text-sm font-normal mb-3 mr-[27px]">Pet Registration</span>
            <span className="text-[#FF8C42] text-sm font-normal mb-3 mr-[46px]">Digital Pet ID</span>
            <span className="text-[#FF8C42] text-sm font-normal mb-3">Vaccination Tracker</span>
            <span className="text-[#FF8C42] text-sm font-normal mr-[53px]">Lost Pet QR</span>
          </div>
