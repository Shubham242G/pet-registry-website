  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="keywords" 
          content="Tailio about, pet registration India, pet compliance, pet ownership, pet registration Delhi NCR, pet registration platform, responsible pet ownership, pet parents India" 
        />
        <link rel="canonical" href="https://tailio.com/about" />
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": {
                ...
                "description": "Pet registration and compliance platform for pet parents in India.",
            ...
            <div style={{
              ...
              <div style={{
                ...
                <img 
                  ...
                  alt="Kaavya Chhabra - Founder of Tailio, pet parent of Mylo and Felix" 
                  style={{ 
                    width: '100%', 
                    height: '100%',
                    objectFit: 'cover',
