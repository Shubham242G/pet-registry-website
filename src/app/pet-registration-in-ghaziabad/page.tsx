  ...
  return (
    <>
      <Head>
        ...
        <meta 
          name="keywords" 
          content="Ghaziabad pet registration, GMC pet registration, GMC dog registration, pet registration Ghaziabad, dog registration Ghaziabad, Ghaziabad Municipal Corporation pet registration, pet registration GMC online, pet certificate Ghaziabad, pet compliance Ghaziabad, pet registration law Ghaziabad, ABC rules Ghaziabad, Supreme Court pet registration Ghaziabad, GMC fee hike, Ghaziabad pet fine" 
        />
        <link rel="canonical" href="https://tailio.com/ghaziabad" />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tailio.com/ghaziabad" />
        ...
        <meta name="twitter:url" content="https://tailio.com/ghaziabad" />
        <meta name="twitter:title" content="Ghaziabad Pet Registration | GMC Pet Registration Online | Tailio" />
        <meta 
          name="twitter:description" 
          content="Register your pet with GMC Ghaziabad in under 60 seconds. Get your official pet registration certificate in 24-72 hours. Starting at ₹999." 
        />
        <meta name="twitter:image" content="https://tailio.com/images/og-ghaziabad.jpg" />
        ...
        {/* Schema.org structured data for Ghaziabad page */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Ghaziabad Pet Registration with GMC",
              "description": "Complete guide to pet registration in Ghaziabad. Register your pet with GMC through Tailio in under 60 seconds.",
              "url": "https://tailio.com/ghaziabad",
              "mainEntity": {
                "@type": "LocalBusiness",
                "name": "Tailio - Ghaziabad Pet Registration",
                "description": "Digital pet registration service for Ghaziabad residents. File directly with GMC.",
                "url": "https://tailio.com/ghaziabad",
                "address": {
                  "@type": "PostalAddress",
                ...
                "availableService": [
                  {
                    "@type": "Service",
                    "name": "GMC Pet Registration",
                    "description": "File pet registration with Ghaziabad Municipal Corporation",
        ...
        {/* FAQ Schema for Ghaziabad-specific FAQs */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Ghaziabad Pet Registration",
                  "item": "https://tailio.com/ghaziabad"
                }
              ]
            })
          }}
      ...
      <main className="min-h-screen bg-[#FAF6EF]">
        ...
        <section className="relative overflow-hidden pt-20 pb-12 px-4">
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            ...
            <button 
              ...
              aria-label="Register your pet with GMC Ghaziabad now"
            >
        ...
        {/* Stats Bar */}
        <section className="bg-[#2C1A0E] py-8 px-4" aria-label="Ghaziabad pet registration statistics">
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { value: 'Active', label: 'GMC enforcement status', sub: 'India · WHO data' },
        ...
        <section className="py-20 px-4 max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="bg-white rounded-xl p-4 border-l-4 border-[#B85C00] shadow-sm">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-[#2C1A0E] text-sm font-semibold">Ghaziabad — key fact</div>
                    <div className="text-[#7A5C40] text-xs leading-relaxed">Ghaziabad raised its municipal registration fee from ₹200 to ₹1,000 in April 2024 — the steepest fee hike in NCR, signalling serious enforcement intent.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2C1A0E] rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-[#F4E4CF]/30 text-xs font-mono uppercase tracking-wider mb-1">Non-compliance fine · GMC</div>
                <div className="text-6xl md:text-7xl font-black text-[#FF8C3A]">₹5,000</div>
                <div className="text-[#F4E4CF]/40 text-sm mt-1">GMC fee raised from ₹200 → ₹1,000 in April 2024</div>
                <div className="mt-6 space-y-3">
                  {[
                    ...
                    { icon: 'clock', text: 'GMC portal fee ₹1,000 · 2–3 weeks wait' }
                  ].map((item, index) => (
        ...
        <section className="py-20 px-4 bg-[#F3EDE0]">
          <div className="max-w-5xl mx-auto">
            <div className="mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mt-2">Four reasons every Ghaziabad pet owner needs this.</h2>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { title: 'Legal Identity & Protection', desc: 'Unique GMC ID — proof of ownership and full legal status. Legally protected at all times.', icon: 'shield' },
        ...
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#F4E4CF]/40 text-sm max-w-lg mx-auto mt-3">Upload digitally on Tailio — no photocopies, no office visits. We handle the GMC filing for you.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { title: 'Address Proof', desc: 'Proof you reside in Ghaziabad. Must show your current address clearly.', details: ['Aadhaar Card (serves as both)', 'Electricity or water bill', 'Rental agreement or bank statement'], icon: 'address' },
        ...
        <section className="py-20 px-4 bg-[#F3EDE0]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="text-[#E8600A] text-xs font-medium uppercase tracking-widest">Tailio vs GMC Portal</div>
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mt-2">
                Or spend a weekend at the
                <span className="text-[#E8600A] italic block">GMC office.</span>
              </h2>
            </div>
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-[#2C1A0E] grid grid-cols-3">
                ...
                <div className="px-6 py-6 text-center"><span className="text-[#F4E4CF]/35 text-[10px] font-mono uppercase tracking-wider">GMC Portal</span></div>
              </div>
              {[
                ...
                { label: 'Registration cost', sub: 'One-time, all-inclusive', tailio: '₹999', portal: '₹1,000' },
                { label: 'If you wait, the fine is…', sub: 'GMC enforcement active', tailio: 'None', portal: '₹5,000' },
              ].map((row, i) => (
                <div key={i} className="grid grid-cols-3 border-b border-[#2C1A0E]/10 last:border-0 bg-[#FFFCF8]">
                  ...
                  <div className="px-6 py-4 flex items-center justify-center">
                    {typeof row.portal === 'string' ? (
                      <span className={`text-sm ${row.portal === '₹5,000' ? 'text-[#A0251E] font-bold' : 'text-[#2C1A0E]'}`}>{row.portal}</span>
                    ) : (
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#2C1A0E" strokeWidth="2">
        ...
        <section className="py-20 px-4 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#7A5C40] text-sm max-w-lg mx-auto mt-3">No PDFs, no notarised forms, no office visits. Works on any phone, anywhere in Ghaziabad.</p>
          </div>
          <div className="relative">
            ...
            {[
              ...
              { num: 2, title: 'Upload your 4 documents', desc: 'Upload digitally — JPG, PNG or PDF. No photocopies, no office visit. We handle the GMC filing on your behalf.', tags: ['Anti-Rabies Cert', 'ID + Address Proof', 'Photo with pet'] },
              { num: 3, title: 'We file with GMC. You get your certificate.', desc: 'Tailio submits directly to GMC (Ghaziabad Municipal Corporation). Your official digital certificate arrives by email within 24–72 hours. No office visit. Ever.', tags: ['Registered in Ghaziabad', 'No office visit', 'Verified'] },
            ].map((step, i) => (
                      ...
                      {step.num === 3 && (
                        <div className="mt-6 bg-[#2C1A0E] rounded-xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                          <div>
                            ...
                            <div className="text-[#F4E4CF]/35 text-[10px] font-mono tracking-wider">TL-GZ-2025-33817</div>
                            <div className="flex flex-wrap gap-2 mt-3">
                              {['Registered in Ghaziabad', 'No office visit', 'Verified'].map((tag) => (
        ...
        <section className="py-20 px-4 max-w-2xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mt-6">
            <div className="w-10 h-10 bg-[#E8600A] rounded-full flex items-center justify-center text-white font-bold">S</div>
            <div className="text-left">
              <div className="flex items-center gap-2">
                <span className="text-[#2C1A0E] font-semibold">Sneha Kapoor</span>
                <span className="px-2 py-0.5 bg-[#FFF0E4] rounded-full text-[#C04E06] text-xs font-semibold border border-[#FFCCA0]">🐾 Coco</span>
              </div>
              <div className="text-[#7A5C40] text-xs">Indirapuram, Ghaziabad</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#F4E4CF]/40 text-sm mt-3 max-w-lg mx-auto">Sixty seconds from here to legally issued. Certificate valid with GMC.</p>
            <div className="mt-12 bg-white/5 rounded-2xl p-8 md:p-10 border border-[#E8600A]/30 relative overflow-hidden">
              ...
              <div className="relative z-10 mt-6">
                ...
                <div className="text-[#F4E4CF]/40 text-xs mt-1">Per pet · Valid 1 year · All taxes inclusive · GMC accepted</div>
              </div>
              ...
              <button 
                ...
                aria-label="Register your pet with GMC Ghaziabad now for ₹999"
              >
                Register Your Pet — ₹999 →
              </button>
