...
export default function LandingPage() {
  ...
  return (
    <div style={{ width: '100%', background: 'white' }}>
      {/* Main Container */}
      <div style={{ width: '100%', background: '#F5F0E8', overflow: 'hidden' }}>
        ...
        <div style={{ width: '100%', padding: getResponsivePadding(), background: '#F5F0E8' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            ...
            <div>
              <div>
                <span style={{ color: '#2B1F14', fontSize: getHeadingFontSize(), fontFamily: 'Fraunces', fontWeight: 700, lineHeight: isMobile ? '1.2' : '80px', wordWrap: 'break-word' }}>
                  Two screens.<br/>
                </span>
        ...
        <div style={{ width: '100%', padding: getResponsivePadding(), background: '#F5F0E8' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <div>
                <span style={{ color: '#2B1F14', fontSize: getSubheadingFontSize(), fontFamily: 'Fraunces', fontWeight: 700, lineHeight: '63px' }}>Follow the</span>
                <span style={{ color: '#2B1F14', fontSize: getSubheadingFontSize(), fontFamily: 'Playfair Display', fontWeight: 700, lineHeight: '63px' }}> </span>
            ...
            {[
              {
                ...
                description: "Fill in a handful of fields — your pet's name, breed, and age. Works on any phone. No PDFs to download, no notarised forms, no Sunday lost to paperwork.",
                tags: ["Pet's name & breed", "Age & gender", "Under 60 seconds"]
              },
              {
                number: 2,
                title: "Upload your 4 documents",
                description: "Upload them digitally — no photocopies, no office visits. JPG, PNG or PDF accepted. We handle the municipal filing on your behalf.",
                documents: [
              ...
              {
                number: 3,
                title: "We file. You get your certificate.",
                description: "We submit directly to your municipality — MCD, Noida Authority, or GMC. Your official digital certificate arrives by email within 24–72 hours. No office visit. Ever."
              }
            ].map((step, idx) => (
              <div key={idx} style={{ marginBottom: idx < 2 ? 40 : 0, position: 'relative' }}>
                <div style={{
                  background: '#FDFAF5',
                  borderRadius: 20,
                  padding: '32px 44px',
                  ...
                  <h3 style={{ color: '#2B1F14', fontSize: 26, fontFamily: 'Fraunces', fontWeight: 700, lineHeight: '31.20px', marginBottom: 12 }}>
                    {step.title}
                  </h3>
                ...
                {idx < 2 && (
                  <div style={{ display: 'flex', justifyContent: 'center', marginTop: 20, marginBottom: 20 }}>
                    <div style={{
                      ...
                      <span style={{ color: 'white', fontSize: 22, fontFamily: 'Fraunces', fontWeight: 900 }}>{step.number}</span>
                    </div>
                  </div>
                )}
              </div>
        ...
        <div style={{ width: '100%', background: '#2B1F14', padding: getResponsivePadding() }}>
          <div style={{ maxWidth: 1140, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <div>
                <span style={{ color: '#F5F0E8', fontSize: getSubheadingFontSize(), fontFamily: 'Playfair Display', fontWeight: 700, lineHeight: '63px' }}>Four documents.<br/></span>
                <span style={{ color: '#D4521A', fontSize: getSubheadingFontSize(), fontFamily: 'Playfair Display', fontStyle: 'italic', fontWeight: 700, lineHeight: '63px' }}>That's all.</span>
              </div>
              <div style={{ maxWidth: 460, margin: '20px auto 0' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(2, 1fr)', gap: 20 }}>
              {[
                ...
                <div key={doc.number} style={{
                  ...
                  <h4 style={{ color: '#F5F0E8', fontSize: 18, fontFamily: 'DM Serif Display', fontWeight: 400, marginBottom: 12 }}>{doc.title}</h4>
        ...
        <div style={{ width: '100%', background: '#F3EDE0', padding: getResponsivePadding() }}>
          <div style={{ maxWidth: 1180, margin: '0 auto' }}>
            <div style={{ marginBottom: 52 }}>
              <div style={{ display: 'inline-flex', padding: '5px 14px', background: '#FFF0E4', borderRadius: 100, marginBottom: 20 }}>
              ...
              <h2 style={{ color: '#2C1A0E', fontSize: isMobile ? '36px' : '52px', fontFamily: 'Fraunces', fontWeight: 700 }}>
            ...
            <div style={{ background: 'white', borderRadius: 18, overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 600 }}>
                <thead>
                  <tr><th style={{ textAlign: 'left', padding: '17px 24px', borderBottom: '1px solid rgba(44, 26, 14, 0.10)', color: '#A68660', fontSize: 13, fontWeight: 400, textTransform: 'uppercase' }}>What you get</th>
        ...
        <div style={{ width: '100%', background: '#2B1F14', padding: getResponsivePadding() }}>
          <div style={{ maxWidth: 740, margin: '0 auto', textAlign: 'center' }}>
            ...
            <h2 style={{ color: '#F5F0E8', fontSize: getSubheadingFontSize(), fontFamily: 'Fraunces', fontWeight: 700, lineHeight: '63px', marginBottom: 20 }}>
              Done.<br/>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            <h2 style={{ color: 'white', fontSize: isMobile ? '36px' : '58px', fontFamily: 'Fraunces', fontWeight: 700, lineHeight: '62.64px', marginBottom: 20 }}>
