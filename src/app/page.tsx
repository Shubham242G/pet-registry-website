  ...
  return (
    <div style={{ fontFamily: F.dmSans, overflowX: 'hidden', width: '100%', margin: 0, padding: 0, background: '#FAF6EF' }}>
      ...
      <div style={{ 
        ...
        {/* Background Images (left and right) - hide on mobile */}
        {!isMobile && (
          <>
        ...
        <div style={{ 
          ...
          <div style={{ width: isMobile ? '100%' : 652, display: 'flex', flexDirection: 'column', gap: 14.9 }}>
            ...
            {/* Description */}
            <p style={{ maxWidth: isMobile ? '100%' : 480, color: '#7A5C40', fontSize: getResponsiveFontSize(14.5, 13, 12), fontFamily: F.dmSans, lineHeight: '23.93px', margin: 0 }}>
          ...
          <div style={{ marginTop: 40, background: '#FAF6EF', borderRadius: 20, overflow: 'hidden', display: 'flex', flexDirection: isMobile ? 'column' : 'row' }}>
            ...
            <div style={{ flex: 1, padding: isMobile ? '24px' : '36px 40px', textAlign: 'left' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                ...
                <span style={{ color: '#C04E06', fontSize: getResponsiveFontSize(10, 9, 9), fontFamily: F.dmSans, fontWeight: 500, textTransform: 'uppercase' }}>Legal Warning</span>
              </div>
      ...
      <div style={{ background: '#F3EDE0', width: '100%' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: getResponsivePadding() }}>
          ...
          {/* Step 1 */}
          <div style={{ background: '#FFFCF8', borderRadius: 20, padding: isMobile ? '20px' : '24px 28px', marginBottom: 40 }}>
            ...
            <div style={{ maxWidth: isMobile ? '100%' : 514, margin: '0 auto' }}>
              ...
              <p style={{ color: '#7A5C40', fontSize: getResponsiveFontSize(13.5, 12, 11), marginTop: 18 }}>A handful of fields. No PDFs to download, no notarised forms, no Sunday lost to paperwork.</p>
            </div>
          </div>
            ...
            <div style={{ maxWidth: isMobile ? '100%' : 514, margin: '0 auto' }}>
              {[
                ...
                <div key={doc.label} style={{ padding: 14, background: '#FAF6EF', borderRadius: 13, marginBottom: 10, display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ width: 38, height: 38, background: '#FFF0E4', borderRadius: 9, flexShrink: 0 }} />
                  <div style={{ flex: 1 }}>
                  ...
                  <div style={{ width: 22, height: 22, background: doc.done ? '#E6F6ED' : '#F3EDE0', borderRadius: 11, flexShrink: 0 }} />
                </div>
              ))}
              ...
              <div style={{ padding: '11px 14px', background: '#E6F6ED', borderRadius: 9, fontSize: getResponsiveFontSize(11.5, 10, 10) }}>
              ...
              <p style={{ color: '#2C1A0E', fontSize: getResponsiveFontSize(20, 18, 16), fontWeight: 700, marginTop: 24 }}>Upload, we'll do the rest.</p>
              <p style={{ color: '#7A5C40', fontSize: getResponsiveFontSize(13.5, 12, 11) }}>No office visits, no photocopies. We file directly with your municipality on your behalf.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div style={{ background: '#3A1F0A', borderRadius: 24, overflow: 'hidden', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr' }}>
            ...
            <div style={{ padding: isMobile ? '32px' : '44px', display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: 2, marginTop: 14, flexWrap: 'wrap' }}>
                ...
                <span style={{ color: '#FF8C3A', fontSize: getResponsiveFontSize(56, 44, 32), paddingBottom: 4 }}>/-</span>
              </div>
              <div><span style={{ color: 'rgba(250,246,239,0.35)', fontSize: getResponsiveFontSize(12, 11, 10) }}>Regular price </span><span style={{ textDecoration: 'line-through', color: 'rgba(250,246,239,0.35)', fontSize: getResponsiveFontSize(12, 11, 10) }}>₹1,999</span></div>
              <div><span style={{ color: 'rgba(250,246,239,0.38)', fontSize: getResponsiveFontSize(11.5, 10, 9) }}>Inclusive of all taxes & GST</span></div>
              <div><span style={{ color: '#FF8C3A', fontSize: getResponsiveFontSize(12, 11, 10), fontWeight: 600 }}>Per pet · Valid for 1 year</span></div>
              ...
              <div style={{ display: 'flex', gap: 20, marginTop: 18, flexWrap: 'wrap' }}>
                {['Secure payment', 'Legally valid', '24–72 hr approval'].map((badge) => (
                  <div key={badge} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <span style={{ color: 'rgba(250,246,239,0.38)', fontSize: getResponsiveFontSize(12, 11, 10) }}>{badge}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div style={{ background: 'linear-gradient(163deg, #C04E06 0%, #E8600A 60%, #FF8C3A 100%)', width: '100%' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: isMobile ? '40px 20px' : '34px 40px', textAlign: 'center' }}>
          <div style={{ width: isMobile ? 40 : 52, height: isMobile ? 60 : 78, margin: '0 auto 15px', position: 'relative' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: isMobile ? '40px 20px 0' : '64px 40px 0' }}>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : (isTablet ? 'repeat(2, 1fr)' : '1.5fr 1fr 1fr 1fr'), gap: isMobile ? 32 : 48, paddingBottom: 40, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            <div>
              ...
              <p style={{ color: 'rgba(250,246,239,0.38)', fontSize: getResponsiveFontSize(13, 12, 11), maxWidth: 220 }}>Making pet registration simple, digital, and stress-free across Delhi NCR.</p>
            </div>
            <div>
              <span style={{ color: '#FF8C3A', fontSize: getResponsiveFontSize(10, 9, 9), textTransform: 'uppercase', letterSpacing: '1.4px' }}>Platform</span>
              {['Pet Registration', 'Digital Pet ID', 'Vaccination Tracker', 'Lost Pet QR'].map((item) => <div key={item} style={{ color: 'rgba(250,246,239,0.45)', fontSize: getResponsiveFontSize(13, 12, 11), marginTop: 12 }}>{item}</div>)}
            </div>
            <div>
              <span style={{ color: '#FF8C3A', fontSize: getResponsiveFontSize(10, 9, 9), textTransform: 'uppercase' }}>Cities</span>
              {['Delhi', 'Noida', 'Ghaziabad', 'Gurugram'].map((item) => <div key={item} style={{ color: 'rgba(250,246,239,0.45)', fontSize: getResponsiveFontSize(13, 12, 11), marginTop: 12 }}>{item}</div>)}
            </div>
            <div>
              <span style={{ color: '#FF8C3A', fontSize: getResponsiveFontSize(10, 9, 9), textTransform: 'uppercase' }}>Company</span>
              {['About Tailio', 'Privacy Policy', 'Terms of Service', 'Contact Us'].map((item) => <div key={item} style={{ color: 'rgba(250,246,239,0.45)', fontSize: getResponsiveFontSize(13, 12, 11), marginTop: 12 }}>{item}</div>)}
            </div>
          </div>
          <div style={{ textAlign: 'center', padding: '24px 0 32px' }}>
            <span style={{ color: 'rgba(250,246,239,0.20)', fontSize: getResponsiveFontSize(12, 11, 10) }}>© 2026 Tailio. All rights reserved.</span>
          </div>
        </div>
      </div>
    </div>
