...
//       <Head>
//         {/* Primary Meta Tags */}
//         <title>Register Your Pet Online in India | Tailio Pet Registration</title>
//         <meta 
//           name="description" 
...
//                 "description": "Online pet registration service for dogs, cats, and other pets in India",
...
//               alt="Background pattern - coffee bean print"
//               fill
//               style={{
//                 objectFit: 'cover',
...
//                     <Image src="/images/id.png" alt="Legal warning - pet registration required" width={24} height={24} style={{ objectFit: 'contain' }} />
//                   </div>
...
//                     </div>
//                     <div style={{ marginTop: 8, padding: '8px 12px', background: 'rgba(224,123,32,0.08)', borderRadius: 6 }}>
//                       <span style={{ color: 'rgba(255,255,255,0.45)', fontSize: 11, fontFamily: 'Inter' }}>Final price depends on your city & municipality. We'll show exact amount before payment.</span>
//                     </div>
//                   </div>
...
function SaleBanner() {
  ...
  const getSaleEndDate = () => {
    return SALE_END_DATE.toLocaleDateString('en-IN', { 
      day: 'numeric', 
      month: 'long', 
      year: 'numeric' 
    });
  ...
  return (
    <div style={{
      background: 'linear-gradient(135deg, #1F1108 0%, #2C1A0E 50%, #1F1108 100%)',
      padding: '10px 20px',
      borderBottom: '3px solid #FF8C3A',
      position: 'relative',
      overflow: 'hidden',
    }}>
      <div style={{
        position: 'absolute',
        inset: 0,
        background: 'repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(255,140,58,0.03) 10px, rgba(255,140,58,0.03) 20px)',
        pointerEvents: 'none',
      }} />
      <div style={{
        maxWidth: 1200,
        ...
        <span style={{ 
          ...
          <span style={{ color: '#FF8C3A', marginLeft: 4 }}>25% OFF</span>
        </span>
        <span style={{ 
          ...
          Ends {getSaleEndDate()} · 
          <span style={{ color: '#FF8C3A', fontWeight: 600, marginLeft: 4 }}>
            {daysLeft} days left
          </span>
        </span>
        <div style={{
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div style={{ fontFamily: F.dmSans, width: '100%', margin: 0, padding: 0, background: '#FAF6EF' }}>
        ...
        {/* ══════════════════════════════════════
            SALE BANNER - INDEPENDENCE DAY SALE
        ══════════════════════════════════════ */}
        <SaleBanner />
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                justifyContent: 'center',
                padding: '7px 16px',
                background: 'linear-gradient(135deg, #FF8C3A 0%, #E8600A 100%)',
                borderRadius: 100,
                gap: 8,
                alignSelf: isMobile ? 'center' : 'flex-start',
                flexWrap: 'wrap',
                boxShadow: '0px 4px 12px rgba(232,96,10,0.3)',
                animation: 'pulse-sale 2s infinite',
              }}>
                <span style={{ color: 'white', fontSize: getResponsiveFontSize(11.5, 10, 9), fontFamily: F.dmSans, fontWeight: 600 }}>
                  🎉 25% OFF Independence Day Sale
                </span>
              </div>
  ...
  >
    Why it matters
  </Link>  {/* ✅ Fixed: Changed from </button> to </Link> */}
</div>
              ...
              <div style={{
                ...
                background: '#FFFCF8',
                borderRadius: 12,
                outline: '1px solid rgba(232,96,10,0.2)',
                outlineOffset: -1,
                width: '100%',
                maxWidth: 400,
                transition: 'all 0.3s ease',
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '0px 4px 16px rgba(232,96,10,0.15)';
              ...
              onMouseLeave={(e) => {
                ...
                <div>
                  <div style={{ color: '#2C1A0E', fontSize: 13, fontWeight: 600 }}>
                    Register now at <span style={{ color: '#E8600A' }}>₹299</span>
                  </div>
                  <div style={{ color: '#A68660', fontSize: 11 }}>
                    <span style={{ textDecoration: 'line-through', marginRight: 6 }}>₹599</span>
                    25% off · Independence Day Sale
                  </div>
                </div>
                <div style={{
          ...
          <div style={{ maxWidth: 800, margin: '0 auto', padding: getResponsivePadding(), textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                ...
                {
                  q: 'How much does registration cost on Tailio?',
                  a: 'Registration costs ₹299 all-inclusive (launch offer, regular price ₹599). This covers municipal filing, digital certificate, vaccination tracker, and renewal reminders. No hidden charges.'
                },
                {
                  q: 'Can I register cats and other pets — not just dogs?',
                  a: 'Currently, we support dog registration across Delhi NCR. Support for cats and other pets is coming soon. Stay tuned!'
