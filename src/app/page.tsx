  ...
  return (
    <>
      <Head>
        ...
        <title>Tailio - Pet Registration Made Easy | Legal Pet ID in 1 Minute</title>
        <meta name="description" content="Register your pet legally in Delhi NCR. Get verified digital ID, vaccination records, and full compliance with Supreme Court mandates. Start your pet registration in 1 minute." />
        <meta name="keywords" content="pet registration, dog registration, pet license, Delhi pet registration, Noida pet registration, pet compliance, pet ID" />
        <link rel="canonical" href="https://tailio.in" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="Tailio - Pet Registration Made Easy" />
        <meta property="og:description" content="Register your pet legally in Delhi NCR. Get verified digital ID and full compliance in 1 minute." />
        <meta property="og:image" content="https://tailio.in/images/og-image.png" />
        <meta property="og:url" content="https://tailio.in" />
        <meta property="og:type" content="website" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Tailio - Pet Registration Made Easy" />
        <meta name="twitter:description" content="Register your pet legally in Delhi NCR. Get verified digital ID and full compliance in 1 minute." />
        <meta name="twitter:image" content="https://tailio.in/images/twitter-image.png" />
      </Head>
