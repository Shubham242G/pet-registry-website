      ...
      <div className="bg-[#2C1A0E] px-4 sm:px-12 py-2.5 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-[#F4E4CF]/75 font-medium text-[13.5px]">
            MCG enforcement is coming. Register now before fines are announced. · Fine for non-compliance with MCG:
          </span>
          <span className="text-[#FF8C3A] font-bold text-[13.5px]">Pending</span>
        </div>
