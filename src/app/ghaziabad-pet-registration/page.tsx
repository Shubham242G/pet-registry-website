      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <p style={{ maxWidth: "580px", margin: "22px auto 0", fontSize: "16.5px", fontFamily: F.dmSans, fontWeight: 400, color: "#7A5C40", lineHeight: "27.72px" }}>
            ...
            handles the GMC filing for ₹299 + municipal fees.
          </p>

          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "8px", marginTop: "38px" }}>
            {["₹299 + municipal fees", "GMC accepted", "Certificate in 24–72 hrs", "No office visit needed"].map((text) => (
              <div key={text} style={{
                display: "inline-flex",
                alignItems: "center",
                gap: "7px",
        ...
        <div style={{ maxWidth: "1120px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ background: "#FFFCF8", borderRadius: 18, overflow: "hidden", boxShadow: "0px 12px 48px rgba(44, 26, 14, 0.12)" }}>
            ...
            {[
              ...
              { feature: "Registration cost", sub: "One-time, all-inclusive", tailio: "₹299 + fees", portal: "₹1,000", isIcon: false },
      ...
      <div style={{ width: "100%", background: "#F3EDE0", padding: "80px 40px", textAlign: "center" }}>
        <div style={{ maxWidth: 660, margin: "0 auto" }}>
          ...
          <blockquote style={{ fontSize: 24, fontFamily: F.fraunces, fontStyle: "italic", fontWeight: 700, color: "#2C1A0E", lineHeight: "35px", margin: 0 }}>
            "The vaccination reminder alone is worth it. I used to forget booster dates all the time. Now Tailio pings me on WhatsApp a week before. My vet loves it too."
          </blockquote>
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", width: "100%" }}>
            <div style={{
              ...
              <div style={{ marginBottom: 20, textAlign: "center" }}>
                ...
                <div style={{ marginTop: 4 }}>
                  <span style={{ color: "#E07B20", fontSize: 12, fontFamily: "Inter", fontWeight: 600 }}>Per pet · Valid for 1 financial year · GMC accepted</span>
                </div>
              </div>
              ...
              <div style={{ display: "flex", justifyContent: "center", gap: 24, flexWrap: "wrap" }}>
                {["Secure payment", "Legally valid with GMC", "24–72 hr approval"].map((text) => (
