...
export default function FaridabadPage() {
  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>Pet Registration in Faridabad | Dog License Registration – Tailio</title>
        <meta 
          name="description" 
          content="Register your pet online in Faridabad with Tailio. Fast and legally valid dog registration service with complete municipal filing support. Apply online today." 
        />
        <meta 
          name="keywords" 
          content="Faridabad pet registration, MCF pet registration, dog registration Faridabad, pet registration Faridabad, Municipal Corporation Faridabad pet registration, pet certificate Faridabad, pet compliance Faridabad, pet registration law Faridabad" 
        />
        <link rel="canonical" href="https://tailio.com/faridabad" />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://tailio.com/faridabad" />
        <meta property="og:title" content="Faridabad Pet Registration | MCF Pet Registration Online | Tailio" />
        <meta 
          property="og:description" 
          content="Register your pet with Municipal Corporation Faridabad (MCF) in under 60 seconds. Tailio files directly with MCF. Get your official pet registration certificate in 24-72 hours." 
        />
        <meta property="og:image" content="https://tailio.com/images/og-faridabad.jpg" />
        ...
        <meta name="twitter:url" content="https://tailio.com/faridabad" />
        ...
        {/* Schema.org structured data for Faridabad page */}
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              "name": "Faridabad Pet Registration with MCF",
              "description": "Complete guide to pet registration in Faridabad. Register your pet with Municipal Corporation Faridabad through Tailio in under 60 seconds.",
              "url": "https://tailio.com/faridabad",
              "mainEntity": {
                "@type": "LocalBusiness",
                "name": "Tailio - Faridabad Pet Registration",
                "description": "Digital pet registration service for Faridabad residents. File directly with Municipal Corporation Faridabad.",
                "url": "https://tailio.com/faridabad",
                "address": {
                  "@type": "PostalAddress",
                ...
                "availableService": [
                  {
                    "@type": "Service",
                    "name": "MCF Pet Registration",
                    "description": "File pet registration with Municipal Corporation Faridabad",
        ...
        {/* FAQ Schema for Faridabad-specific FAQs */}
        <script
          type="application/ld+json"
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
            ...
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                },
                {
                  "@type": "ListItem",
                  "position": 2,
                  "name": "Faridabad Pet Registration",
                  "item": "https://tailio.com/faridabad"
                }
              ]
            })
          }}
      ...
      <main className="min-h-screen bg-[#FAF6EF]">
        ...
        <section className="relative overflow-hidden pt-20 pb-12 px-4">
          ...
          <div className="relative max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-[#FFF0E4] rounded-full px-3 py-1.5 border border-[#FFCCA0] mb-6">
              ...
              <span className="text-[#C04E06] text-sm font-medium">MCF · Faridabad · Registration Live</span>
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-7xl font-black text-[#2C1A0E] leading-tight mb-4">
              Pet registration
              <span className="text-[#E8600A] italic block sm:inline"> in Faridabad.</span>
            </h1>
        ...
        {/* Stats Bar - Faridabad specific */}
        <section className="bg-[#2C1A0E] py-8 px-4" aria-label="Faridabad pet registration statistics">
        ...
        {/* Law Section - Faridabad specific */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="bg-white rounded-xl p-4 border-l-4 border-[#2C1A0E]/10 shadow-sm">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-[#2C1A0E] text-sm font-semibold">Faridabad — key fact</div>
                    <div className="text-[#7A5C40] text-xs leading-relaxed">Faridabad has seen increasing enforcement of pet registration laws. MCF conducts regular drives to ensure compliance across the city.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2C1A0E] rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-[#F4E4CF]/30 text-xs font-mono uppercase tracking-wider mb-1">Non-compliance fine · MCF</div>
                <div className="text-6xl md:text-7xl font-black text-[#FF8C3A]">₹500+</div>
                <div className="text-[#F4E4CF]/40 text-sm mt-1">Fines up to ₹5,000 under MCF regulations</div>
                <div className="mt-6 space-y-3">
                  {[
                    { icon: 'alert', text: 'Legal action from municipal authorities' },
                    { icon: 'id', text: 'No legal proof of ownership without registration' },
                    { icon: 'clock', text: 'MCF portal fee · 2–4 weeks processing time' }
                  ].map((item, index) => (
        ...
        <section className="py-20 px-4 bg-[#F3EDE0]">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                { title: 'Legal Identity & Protection', desc: 'Unique MCF ID — proof of ownership and full legal status. Legally protected at all times.', icon: 'shield' },
        ...
        {/* Documents Needed - Faridabad specific (6 documents) */}
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#F4E4CF]/40 text-sm max-w-lg mx-auto mt-3">Upload digitally on Tailio — no photocopies, no office visits. We handle the MCF filing for you.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                { title: 'Proof of Identity', desc: 'Any government-issued photo ID of the pet owner. Must be valid and clearly legible.', details: ['Aadhaar Card', 'PAN Card', 'Passport or Voter ID'], icon: 'id' },
                { title: 'Proof of Address', desc: 'Proof you reside in Faridabad. Must show your current address clearly.', details: ['Aadhaar Card (serves as both)', 'Electricity or water bill', 'Rental agreement or bank statement'], icon: 'address' },
                { title: 'Vaccination Record', desc: 'Complete vaccination record of your pet, including anti-rabies vaccination.', details: ["Pet's name, gender & age", 'Vaccination dates', "Vet's signature & hospital stamp"], icon: 'certificate' },
                { title: 'Pet Photographs', desc: 'Clear, recent photographs of your pet from different angles.', details: ['Front view', 'Side view', 'Good natural lighting'], icon: 'photo' },
                { title: 'Sterilization Certificate', desc: 'Sterilization/spaying certificate from a registered vet.', details: ['Certificate from registered vet', 'Date of procedure', "Vet's signature & stamp"], icon: 'sterilization' },
                { title: 'Microchip Details', desc: 'Microchip number and registration details of your pet.', details: ['Microchip number', 'Registration date', 'Manufacturer details'], icon: 'microchip' },
              ].map((doc, i) => (
        ...
        {/* Comparison Table - Faridabad specific */}
        <section className="py-20 px-4 bg-[#F3EDE0]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="text-[#E8600A] text-xs font-medium uppercase tracking-widest">Tailio vs MCF Portal</div>
              <h2 className="text-3xl md:text-4xl font-black text-[#2C1A0E] leading-tight mt-2">
                Or spend a weekend at the
                <span className="text-[#E8600A] italic block">MCF office.</span>
              </h2>
            </div>
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              <div className="bg-[#2C1A0E] grid grid-cols-3">
                ...
                <div className="px-6 py-6 text-center"><span className="text-[#F4E4CF]/35 text-[10px] font-mono uppercase tracking-wider">MCF Portal</span></div>
              </div>
              {[
        ...
        <section className="py-20 px-4 max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#7A5C40] text-sm max-w-lg mx-auto mt-3">No PDFs, no notarised forms, no office visits. Works on any phone, anywhere in Faridabad.</p>
          </div>
          <div className="relative">
            ...
            {[
              ...
              { num: 2, title: 'Upload your 6 documents', desc: 'Upload digitally — JPG, PNG or PDF. No photocopies, no office visit. We handle the MCF filing on your behalf.', tags: ['Proof of Identity', 'Proof of Address', 'Vaccination Record'] },
              { num: 3, title: 'We file with MCF. You get your certificate.', desc: 'Tailio submits directly to MCF (Municipal Corporation Faridabad). Your official digital certificate arrives by email within 24–72 hours. No office visit. Ever.', tags: ['Registered in Faridabad', 'No office visit', 'Verified'] },
            ].map((step, i) => (
                      ...
                      {step.num === 3 && (
                        <div className="mt-6 bg-[#2C1A0E] rounded-xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                          <div>
                            ...
                            <div className="text-[#F4E4CF]/35 text-[10px] font-mono tracking-wider">TL-FBD-2025-88471</div>
                            <div className="flex flex-wrap gap-2 mt-3">
                              {['Registered in Faridabad', 'No office visit', 'Verified'].map((tag) => (
        ...
        <section className="py-20 px-4 max-w-2xl mx-auto text-center">
          ...
          <blockquote className="text-[#2C1A0E] text-2xl font-bold italic leading-relaxed">
            "I wasn't sure if registration was required in Faridabad. Tailio made it so simple — done in 5 minutes from my phone. Max is now officially registered with MCF!"
          </blockquote>
          <div className="flex items-center justify-center gap-3 mt-6">
            ...
            <div className="text-left">
              <div className="flex items-center gap-2">
                <span className="text-[#2C1A0E] font-semibold">Amit Kumar</span>
                <span className="px-2 py-0.5 bg-[#FFF0E4] rounded-full text-[#C04E06] text-xs font-semibold border border-[#FFCCA0]">🐾 Max</span>
              </div>
              <div className="text-[#7A5C40] text-xs">Sector 12, Faridabad</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 bg-[#2C1A0E]">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#F4E4CF]/40 text-sm mt-3 max-w-lg mx-auto">Sixty seconds from here to legally issued. Certificate valid with MCF.</p>
            <div className="mt-12 bg-white/5 rounded-2xl p-8 md:p-10 border border-[#E8600A]/30 relative overflow-hidden">
              ...
              <div className="mt-8 space-y-3 text-left relative z-10">
                {[
                  'MCF Municipal Filing — all paperwork end to end',
