          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": {
                ...
                "address": {
                  "@type": "PostalAddress",
                  "streetAddress": "412, Emaar Colonnade, Sector-66, Golf Course Extension Road",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Is pet registration really mandatory in Delhi NCR?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes. The Supreme Court of India through the Animal Birth Control (ABC) Rules 2023 and its August 2025 order directed MCD/MCG to enforce mandatory pet registration across Delhi NCR."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes, Tailio is authorized to submit registrations directly to MCD/MCG. Your certificate is officially recognized and legally valid across all zones."
                  }
                },
                {
                  "@type": "Question",
                  "name": "How long does the certificate take to arrive?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Your official digital certificate is delivered within 24–72 hours after submission. No office visit required."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "You need four documents: Anti-Rabies Certificate, Applicant ID Proof (Aadhaar/PAN/Passport), Address Proof, and a recent photo with your pet."
                  }
                }
              ]
            })
            ...
            <div style={{ padding: 40 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <input
                  ...
                  aria-label="Pet's registration ID"
                />
              </div>
